...
//	static void litint_ P((int, int *, int, final int *,
//	         int));
...
//	   /* Initialized data */
//
//	   static final int cndtck[10] = { 50,20,10,5,0,156,156,156,157,0 };
//	   static final int lmptck[12] = { 50,30,20,10,4,0,154,154,154,154,155,0 };
//
...
//	   cevent_1.ctick[cindex_1.cevbal - 1] = 0;((int, int *, int, final int *,
//        int));
//	   findex_1.binff = 0;
//	   findex_1.btief = 0;
//	   state_1.bloc = rindex_1.vlbot;
...
//	   /* 						!MOVE MASTER PLAYER. */
//	   return;
	   throw new RuntimeException("Clockr.cevapp_ not impl");
...
//	   }
//	   return;
	   throw new RuntimeException("Clockr.litint_ not impl");
	} /* litint_ */
