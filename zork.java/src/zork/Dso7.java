...
//	   }
//	   findex_1.cphere = st;
		throw new RuntimeException("Dso7.cpgoto not impl");
	} /* cpgoto_ */
...
//	   /* Initialized data */
//
//	   static final int dgmoft[8] = { -9,-8,-7,-1,1,7,8,9 };
//	   final char *pict = "SSS M";
//
//	   /* Local variables */
//	   int i, j, k, l;
//	   char dgm[1*8];
...
//	   }
//	   /* 						!WEST LADDER? */
		throw new RuntimeException("Dso7.cpinfo not impl");
	} /* cpinfo_ */
