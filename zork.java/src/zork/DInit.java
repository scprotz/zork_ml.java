...
//	#define rdint(indxfile) (ch = getc(indxfile) ((ch > 127) ? (ch - 256) : (ch)) * 256 + getc(indxfile))
...
//	   Supp.itime_(vars.time_1.shour, vars.time_1.smin, vars.time_1.ssec);
//	   Supp.srand(vars.time_1.shour[0] ^ (vars.time_1.smin[0] ^ vars.time_1.ssec[0]));
 ...
 /* init_ */
	...
	public void error1925(int i, int j, int k)
	{
		if (Vars.DEBUG)
		{
			...
			System.out.println( LOCALTEXTFILE + " is version " +
			 i + "." + j + "" + (char)k + ".");
			Supp.more_output(null);
	...
	public void error1975()
	{
		if(Vars.DEBUG)
		{
		   ...
		   Supp.more_output("cannot be found.  All must now pass away.\"  Raising his oaken staff");
