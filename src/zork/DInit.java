...
//		   *pf++ = indxfile.read();
	...
	public boolean init_()
	{
		...
		{
			System.err.println("Problem initializating from init file.");
			ioe.printStackTrace();
		}
	...
	public void error1975()
	{
		if (Vars.DEBUG)
		{
			System.out.println("Suddenly a sinister, wraithlike figure appears before you,");
			System.out.println("seeming to float in the air.  In a low, sorrowful voice he says,");
			System.out.println("\"Alas, the very nature of the world has changed, and the dungeon");
			System.out.println(
					"cannot be found.  All must now pass away.\"  Raising his oaken staff");
			System.out.println("in farewell, he fades into the spreading darkness.  In his place");
			System.out.println("appears a tastefully lettered sign reading:");
			System.out.println("");
			System.out.println("                       INITIALIZATION FAILURE");
			System.out.println("");
			System.out.println("The darkness becomes all encompassing, and your vision fails.");
		}
	}
