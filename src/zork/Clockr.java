	...
	void cevapp_(int ri) {
		...
		loop: do {
			...
			case 6000:
				...
				/* AT BOTTOM? */
				if (vars.state_1.bloc == vars.rindex_1.ledg2 || vars.state_1.bloc == vars.rindex_1.ledg3
						|| vars.state_1.bloc == vars.rindex_1.ledg4 || vars.state_1.bloc == vars.rindex_1.vlbot) {
					GOTO = 6700;
					continue loop;
				}
				/* ON LEDGE? */
				if ((vars.objcts_1.oflag2[vars.oindex_1.recep - 1] & Vars.OPENBT) != 0 && vars.findex_1.binff != 0) {
					GOTO = 6500;
					continue loop;
				}
				...
				/* IN BALLOON? */
				if (vars.play_1.here == vars.rindex_1.ledg2 || vars.play_1.here == vars.rindex_1.ledg3
						|| vars.play_1.here == vars.rindex_1.ledg4 || vars.play_1.here == vars.rindex_1.vlbot) {
			...
			case 6800:
				if (vars.findex_1.binff == 0 || !((vars.objcts_1.oflag2[vars.oindex_1.recep - 1] & Vars.OPENBT) != 0)) {
					return;
				}
			...
			case 8200:
				...
				for (i = 1; i <= i__1; ++i) {
					/* BLEW WRONG ROOM. */
					if (game.dsub.qhere_(i, br) && (vars.objcts_1.oflag1[i - 1] & Vars.TAKEBT) != 0) {
						game.dsub.newsta_(i, 0, 0, 0, 0);
					}
					/* case 8250: */
				}
			...
			case 16000:
				vars.cevent_1.cflag[vars.cindex_1.cevfor - 1] = vars.play_1.here == vars.rindex_1.mtree
						|| vars.play_1.here >= vars.rindex_1.fore1 && vars.play_1.here < vars.rindex_1.clear;
			...
			case 20200:
				...
				for (i = 1; i <= i__1; ++i) {
					/* STRIP HIM OF OBJS. */
					game.dsub.newsta_(i, 0, vars.objcts_1.oroom[i - 1], vars.objcts_1.ocan[i - 1], 0);
					/* case 20300: */
				}
				...
				vars.objcts_1.oflag1[vars.oindex_1.lamp
						- 1] = (vars.objcts_1.oflag1[vars.oindex_1.lamp - 1] | Vars.LITEBT) & ~Vars.ONBT;
			...
			case 21000:
				...
				/* DESCRIBE BUTTON. */
				if (vars.play_1.here == vars.rindex_1.inmir || game.dso6.mrhere_(vars.play_1.here) == 1) {
			...
			case 24000:
				...
				/* NO MOVEMENT, DONE. */
				if (vars.play_1.here != vars.rindex_1.cell && vars.play_1.here != vars.rindex_1.pcell) {
					GOTO = 24100;
					continue loop;
				}
...
//	   ++(*ctr);
		...
		if (vars.cevent_1.ctick[cev - 1] != 0) {
			if (vars.objcts_1.oroom[obj - 1] == vars.play_1.here || vars.objcts_1.oadv[obj - 1] == vars.play_1.winner) {
