...
//	case 600:
		if (!(game.dso5.weight_(0, vars.prsvec_1.prso, 0)
				+ game.dso5.weight_(0, vars.prsvec_1.prsi, 0)
				+ vars.objcts_1.osize[vars.prsvec_1.prso
						- 1] <= vars.objcts_1.ocapac[vars.prsvec_1.prsi - 1]))
		{
				...
				case 2000:
					...
					for (vars.prsvec_1.prso = 1; vars.prsvec_1.prso <= vars.objcts_1.olnt; ++vars.prsvec_1.prso)
					{
						...
						if (vars.objcts_1.oadv[vars.prsvec_1.prso - 1] != vars.play_1.winner
								...
								|| savep == v && vars.objcts_1.otval[vars.prsvec_1.prso - 1] <= 0
								|| (vars.objcts_1.oflag1[vars.prsvec_1.prso - 1]
										& Vars.VISIBT) == 0)
						{
							continue;
						}
